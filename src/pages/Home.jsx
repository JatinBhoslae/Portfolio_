    ...
    >
      ...
      >
        ...
        <div className="relative z-10 mt-10text-center min-h-[70vh]">
          ...
          >
            I'm Jatin, a tech enthusiast and Full Stack Developer passionate about building <br />
            innovative, user-friendly, and interactive web applications. <br />
            I enjoy working across both frontend and backend development to create complete and scalable solutions. <br />
            I specialize in technologies like React, JavaScript, Node.js, Express.js, and MongoDB, <br />
            and continuously explore new technologies to improve my skills and build impactful real-world applications.
          </h3>
